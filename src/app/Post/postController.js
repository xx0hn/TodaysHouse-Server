...
exports.getTotalHouseWarm = async function (req, res) {
  ...
  const houseWarmParams = [
    buildingTypeIdForSearch,
    minWidth,
    maxWidth,
    minBudget,
    maxBudget,
    familyTypeIdForSearch,
    styleIdForSearch,
    wallColorIdForSearch,
    floorColorIdForSearch,
    detailWorkIdForSearch,
    areaIdForSearch,
    workerIdForSearch,
  ];
  if (sortType === 'NEW') {
...
exports.getSearch = async function (req, res) {
  ...
  if (type === 'TOTAL') {
    result.push({
      StoreCount: getStoreCounts,
      Stores: getSearchStore,
      HouseWarmCount: getHouseWarmCounts,
      HouseWarms: getSearchHouseWarm,
